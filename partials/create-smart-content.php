                            ...
                            <div style="background: #f8fafc; border: 1px solid #e2e8f0; border-radius: 8px; padding: 12px;">
                                ...
                                <div id="dup-schedule-start-only-container" style="display: none; margin-top: 12px; padding: 12px; background: white; border: 1px solid #e2e8f0; border-radius: 6px;">
                                    <div class="form-group" style="margin-bottom: 10px;">
                                        ...
                                        <input type="datetime-local" id="dup-schedule-start-only-datetime" onchange="updateESTPreview('dup-schedule-start-only-datetime','est-preview-dup-start-only')" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 13px;">
                                        <div id="est-preview-dup-start-only" style="display: none; margin-top: 4px; padding: 6px 10px; background: #fef3c7; border-radius: 4px; font-size: 12px; color: #92400e;"></div>
                                    </div>
                                    <div style="padding: 6px 10px; background: #eff6ff; border-radius: 4px; display: flex; align-items: center; gap: 6px;">
                                        <span style="font-size: 14px;">🕐</span>
                                        <span style="font-size: 11px; color: #1e40af; font-weight: 500;">Pick your local time - auto-converted to EST for TikTok Ads Manager</span>
                                    </div>
                                </div>
                                ...
                                <div id="dup-schedule-datetime-container" style="display: none; margin-top: 12px; padding: 12px; background: white; border: 1px solid #e2e8f0; border-radius: 6px;">
                                    ...
                                    <div style="display: grid; grid-template-columns: 1fr 1fr; gap: 10px;">
                                        <div class="form-group" style="margin-bottom: 0;">
                                            ...
                                            <input type="datetime-local" id="dup-schedule-start-datetime" onchange="updateESTPreview('dup-schedule-start-datetime','est-preview-dup-start')" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 13px;">
                                            <div id="est-preview-dup-start" style="display: none; margin-top: 4px; padding: 6px 10px; background: #fef3c7; border-radius: 4px; font-size: 11px; color: #92400e;"></div>
                                        </div>
                                        <div class="form-group" style="margin-bottom: 0;">
                                            ...
                                            <input type="datetime-local" id="dup-schedule-end-datetime" onchange="updateESTPreview('dup-schedule-end-datetime','est-preview-dup-end')" style="width: 100%; padding: 8px; border: 1px solid #d1d5db; border-radius: 6px; font-size: 13px;">
                                            <div id="est-preview-dup-end" style="display: none; margin-top: 4px; padding: 6px 10px; background: #fef3c7; border-radius: 4px; font-size: 11px; color: #92400e;"></div>
                                        </div>
                                    </div>
                                </div>
                            </div>
